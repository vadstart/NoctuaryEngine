...
VkResult NtSwapChain::acquireNextImage(uint32_t *imageIndex) {
  vkWaitForFences(
      device.device(),
      1,
...
void NtSwapChain::createSwapChain() {
...
void NtSwapChain::createImageViews() {
...
void NtSwapChain::createRenderPass() {
...
void NtSwapChain::createColorResources() {
...
VkPresentModeKHR NtSwapChain::chooseSwapPresentMode(
...
VkExtent2D NtSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat NtSwapChain::findDepthFormat() {
